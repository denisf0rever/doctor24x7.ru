...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const calculateReceiptPrice = () => {
        const comission = receptionCheckbox.checked
            ? (+receptionPriceInput.value / 100) * +receiptComission.value
            : 0;
        const additionalValue = receptionCheckbox2.checked
            ? +receiptCheckbox2Value.value
            : 0;
        receptionTotalPriceInput.setAttribute(
            "value",
            +receptionPriceInput.value + additionalValue + comission
        );
    };
