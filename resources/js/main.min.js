  ...
  if (fullForm) {
    ...
    fullFormConfirmBtn.onclick = async (event) => {
      ...
      if (fullFormConfirmBtn.classList.contains('full-form__confirm-btn-active')) {
        ...
        // Перебираем элементы формы и добавляем их в объект
        ...
        if (formData.to_answer_id) {
          const toAnswerId = Number(formData.to_answer_id);
          formData.to_answer_id = toAnswerId;
        }
