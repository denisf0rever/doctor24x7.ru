...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // $('.mobile-panel-col a').eq(1).click(function (event) {
  //   event.preventDefault();
  ...
  //     $('.mobile-panel-top').addClass('active');
  //     $('.m-tab-nav li').eq(1).addClass('current').siblings().removeClass('current').parents('.m-tab').find('div.m-tab-box').hide().eq(1).fadeIn(200);
  //     if (!isConsultanstsLoaded) {
  //       showFirstEmployeeScreen(1);
  //     }
  //   }
