...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const firstCalc = document.querySelectorAll(
        ".first-radio__list .first-radio__input"
    );
    const secondCalc = document.querySelectorAll(
        ".second-radio__list .second-radio__input"
    );
    ...
    const setPrices = () => {
        ...
        promoCalc.forEach((promoItem) => {
            const basicPrice = promoItem
                .querySelector(".promo__input-radio")
                .getAttribute("stadart-price");
    ...
    document.querySelectorAll(".question-accordion").forEach((question) => {
        question.addEventListener("click", function () {
            const answerWrapper = this.querySelector(
                ".question-accordion__ansver-wrapper"
            );
