...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* КАСТОМНЫЙ СЕЛЕКТОР ПЛАТНОЙ КОНСУЛЬТАЦИИ */

  // const customPayConsultationSelect = () => {
  //   const selectWrappers = document.querySelectorAll('.custom-select');

  //   if (selectWrappers.length > 0) {
  //     selectWrappers.forEach(selectWrapper => {
  //       const select = selectWrapper.querySelector('.custom-select-pay__wrapper');
  //       const selectArrow = selectWrapper.querySelector('.custom-select-pay__arrow');

  //       selectWrapper.onclick = (e) => {
  //         e.stopPropagation(); // предотвращаем всплытие клика
  //         if (selectArrow) {
  //           selectArrow.classList.toggle('custom-select-pay__rotate-arrow');
  //         }
  //         select.classList.toggle('custom-select-pay__hide');
  //       };
