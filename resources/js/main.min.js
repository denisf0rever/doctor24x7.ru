...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const chatFooterFirst = document.querySelector('.chat__footer-first');
  const chatFooterSecond = document.querySelector('.chat__footer-second');

  if (chatNextButton && chatBody && chatAdditionalFields && chatFooterFirst && chatFooterSecond) {
    chatNextButton.onclick = () => {
      chatBody.classList.add('hide');
      chatAdditionalFields.classList.remove('hide');
      chatFooterFirst.classList.add('hide');
      chatFooterSecond.classList.remove('hide');
    }
  }

  if (chatPrevButton && chatBody && chatAdditionalFields && chatFooterFirst && chatFooterSecond) {
    chatPrevButton.onclick = () => {
      chatBody.classList.remove('hide');
      chatAdditionalFields.classList.add('hide');
      chatFooterFirst.classList.remove('hide');
