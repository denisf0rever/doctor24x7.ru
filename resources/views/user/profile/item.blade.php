...
<section class="user-block main__user-block">
  <div class="section-wrapper  section-wrapper">
    <div class="user-block__header-info">
      ...
      <div class="user-block__flex">
        <span class="user-block__info">На сайте с <strong class="user-block__strong">14 ноября 2016 года</strong></span>
        <span class="user-block__info">ID: <strong class="user-block__strong">5121</strong></span>
      </div>

      <span class="user-block__info">Проведено консультаций <strong class="user-block__strong">23710</strong></span>
