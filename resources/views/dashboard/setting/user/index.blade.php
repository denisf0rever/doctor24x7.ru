        ...
        <div class="main__wrapper">
          ...
          <section class="main__form form">
            <div class="form__wrapper">
              <form action="{{ route('dashboard.setting.user.update', auth()->user()->id) }}" method="post" class="form__inner-form"
                      ...
                      <ul class="form__inputs">
                        <li class="form__input-wrapper-row">
                          ...
                          <label class="form__switch form-switch">
                            <input type="hidden" id="answer_form" value="0" name="answer_form">  
                            @if ($settings->answer_form)
                            <input type=" checkbox" id="answer_form" checked class="form-switch__checkbox"
                              name="answer_form">
