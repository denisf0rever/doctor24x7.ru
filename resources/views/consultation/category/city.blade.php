    ...
    <div class="category-intro__inner">
      <div class="category-intro__top">
        ...
        <div class="category-intro__text">
          <p class="category-intro__p">Сервис онлайн-консультации врачей в {{ $city->name_p }} предоставляет возможность
            быстро и удобно получить квалифицированную медицинскую помощь, не выходя из дома. Наша команда опытных
            специалистов готова ответить на ваши вопросы, провести диагностику и предложить рекомендации по лечению
            различных заболеваний. Мы ценим ваше время и здоровье, поэтому гарантируем безопасность и конфиденциальность
            ваших данных. Используя современные технологии, мы обеспечиваем доступ к медицинским консультациям в любое
            время, что позволяет вам почувствовать заботу и внимание к своим проблемам. Выбирайте удобство и качество с
            нашим сервисом, чтобы заботиться о вашем здоровье на высшем уровне.</p>
        </div>
      </div>
