    ...
    <li class="questions__item question">
      <div class="question__wrapper">
        ...
        <div class="question__answer-wrapper">
          <span class="question__answer-text">Наш сервис позволяет пациентам спросить врача онлайн и получить медицинскую помощь, не выходя из дома. Врачи разных специальностей консультируют по видео, аудио или в чате, помогают с расшифровкой анализов, назначением лечения и вторым мнением. Это удобно для занятых людей, жителей удалённых регионов и тех, кому нужна срочная консультация. Доступ к квалифицированной медицине становится проще и быстрее.</span>
        </div>
      </div>
    </li>
	<li class="questions__item question">
