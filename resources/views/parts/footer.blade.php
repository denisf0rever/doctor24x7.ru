    ...
    <div class="footer__wrapper container">
      <div class="footer__left">
        <ul class="footer__links">
          ...
          <li class="footer__links-item"><a href="{{ route('consultation.testimonials') }}" class="footer__link">Отзывы о нас</a></li>
          <li class="footer__links-item"><a href="{{ route('page.terms-of-use') }}" class="footer__link">Пользовательское соглашение</a></li>
